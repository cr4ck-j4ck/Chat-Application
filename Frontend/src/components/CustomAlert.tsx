...
const CustomAlert: React.FC<AlertProps> = ({
  ...
  return (
    ...
    >
      <div className={`relative flex items-start gap-3 px-5 py-4 rounded-xl shadow-2xl animate-bounce-in border ${bg} ${border} ${text} ring-1 ${ring} pr-10`}>
        ...
        <button
          ...
          className={`absolute top-4.5 right-2 ${text} hover:opacity-80 transition`}
        >
          <X className="w-4 h-4" />
        </button>
      </div>
